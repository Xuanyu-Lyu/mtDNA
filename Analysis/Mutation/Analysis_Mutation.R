setwd("/Users/xuly4739/Library/CloudStorage/OneDrive-UCB-O365/Documents/mtDNA/mtDNA/Data/Mutation/c2p12")
path_results2 <- "/Users/xuly4739/Library/CloudStorage/OneDrive-UCB-O365/Documents/mtDNA/mtDNA/Data/Mutation/c2p12"
#load(paste0(path_results,paste0("/modelSmr_",1,".RData")))
df_result <- data.frame("j2_miss"=as.numeric(rep(NA,500)), 
                        "mt2_miss"=as.numeric(rep(NA,500)),
                        "j2"=as.numeric(rep(NA,500)),
                        "mt2"=as.numeric(rep(NA,500))) 



# collect the results of the 500 loops in one data frame
for (loop in 1:500){
    print(loop)
...
g1 =ggplot(df_long, aes(x = value, fill = variable)) +
    ...
    ggtitle("Density Plots of correctly specified M and misspecified M") +
...
save_path = "/Users/xuly4739/Library/CloudStorage/OneDrive-UCB-O365/Documents/mtDNA/mtDNA/Analysis/Mutation"

ggsave( paste0(save_path,"/MutationPlot.png"), g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
