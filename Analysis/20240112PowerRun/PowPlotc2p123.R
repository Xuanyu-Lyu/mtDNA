...
relativePath = "/Users/lyux20/Library/CloudStorage/OneDrive-UCB-O365/Documents/mtDNA/mtDNA/Data/20240112PowerRun"
relativePath_save = "/Users/lyux20/Library/CloudStorage/OneDrive-UCB-O365/Documents/mtDNA/mtDNA/Analysis/20240112PowerRun"
...
### create a new enviroment for one condition
env_c2p2 <- new.env()
load(paste0(relativePath,"/","c2p2/modelSmr.Rdata"), envir = env_c2p2)
...
### create a new enviroment for one condition
env_c2p3 <- new.env()
load(paste0(relativePath,"/","c2p3/modelSmr.Rdata"), envir = env_c2p3)
