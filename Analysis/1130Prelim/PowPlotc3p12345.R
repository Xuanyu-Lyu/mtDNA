...
### create a new enviroment for one condition
env_c3p2 <- new.env()
load(paste0(relativePath,"/","c3p2/modelSmr.Rdata"), envir = env_c3p2)
...
### create a new enviroment for one condition
env_c3p3 <- new.env()
load(paste0(relativePath,"/","c3p3/modelSmr.Rdata"), envir = env_c3p3)
...
df_c3 <- rbind(df_c3p1, df_c3p2, df_c3p3,df_c3p4,df_c3p5)
...
ggsave( paste0(relativePath_save,"/graph_c3p12345.png"), g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
