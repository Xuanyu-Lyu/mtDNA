...
### create a new enviroment for one condition
env_c1p2 <- new.env()
load(paste0(relativePath,"/","c1p2/modelSmr.Rdata"), envir = env_c1p2)
...
### create a new enviroment for one condition
env_c1p3 <- new.env()
load(paste0(relativePath,"/","c1p3/modelSmr.Rdata"), envir = env_c1p3)
...
df_c1 <- rbind(df_c1p1, df_c1p2, df_c1p3,df_c1p4,df_c1p5)
...
ggsave( paste0(relativePath_save,"/graph_c1p12345.png"), g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
